...
export default function EditProductPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(false);
    toast("РўРѕРІР°СЂ СЃРѕС…СЂР°РЅС‘РЅ");
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-5xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[18px] font-bold text-slate-900">РўРѕРІР°СЂ #{id}</h1>
        ...
        <button type="submit" disabled={saving}
          ...
          {saving
            ? <><svg className="animate-spin" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>РЎРѕС…СЂР°РЅРµРЅРёРµ...</>
            : <><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>РЎРѕС…СЂР°РЅРёС‚СЊ</>
          }
        </button>
      </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 flex flex-col gap-3">
            ...
            <div className="grid grid-cols-[1fr_1fr_auto] gap-2">
              ...
              <button type="button" onClick={addSpec}
                className="px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold rounded-xl text-[13px] transition-colors">
