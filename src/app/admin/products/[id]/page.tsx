    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-5xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[18px] font-bold text-slate-900">Товар #{id}</h1>
        ...
        <button type="submit" disabled={saving}
          ...
          {saving
            ...
            : <><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>Сохранить</>
          }
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              <label className={lbl}>Вес, кг/м</label>
              <input type="number" step="0.01" value={form.weightPerMeter || ""}
                onChange={e => set("weightPerMeter", Number(e.target.value))} className={inp} placeholder="0.00" />
            </div>
            <div className="flex flex-col gap-1">
