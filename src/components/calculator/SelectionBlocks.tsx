...
export const SelectionBlocks = ({
  ...
  if (variant === "selects") {
    const selectClass = "h-10 w-full rounded-lg bg-gray-50 px-3 text-[14px] font-semibold text-gray-900 outline-none transition-colors focus:bg-white focus:ring-2 focus:ring-brand-primary/10";
